...
const ParteAsesor = () => {
  ...
  useEffect(() => {
    const totalLeadsHoyF = async () => {
      ...
      try {
        const response = await axios.get(`http://192.168.100.32:8000/api/totalleadsgeneralAsesor/${idUsuario}/`);
  ...
  useEffect(() => {
    const totalLeadsVendidosF = async () => {
      ...
      try {
        const response = await axios.get(`http://192.168.100.32:8000/api/totalleadsVendidosAsesor/${idUsuario}/`);
  ...
  useEffect(() => {
    const obtenerEstados = async () => {
      try {
        const response = await axios.get(`http://192.168.100.32:8000/api/getestados/`);
        console.log(response.data)
  ...
  const clickEstado = async (id_estado, id_lead) => {
    ...
    try {
      ...
      await axios.patch(
        `http://192.168.100.32:8000/api/updateleadestado/${id_lead}/`,
        {
      ...
      const response = await axios.get(
        `http://192.168.100.32:8000/api/getsubestados/${id_estado}/`
      );
  ...
  const confirmarVenta = async () => {
    try {
      ...
      await axios.post(`http://192.168.100.32:8000/api/saveventas/${idLeadSeleccionado}/`, {
  ...
  const clickSubEstado = async (id_subestado, id_lead) => {
    ...
    try {
      ...
      await axios.patch(
        `http://192.168.100.32:8000/api/updateleadsubestado/${id_lead}/`,
        {
  ...
  useEffect(() => {
    const obtenerTipoIteraciones = async () => {
      try {
        const response = await axios.get(`http://192.168.100.32:8000/api/gettipointeraccion/`);
        console.log(response.data)
...
// Enviar tipo iteracion
  const enviarTipoIteracion = async (tipo, id_lead) => {
    ...
    if (tipo !== 2) {
      try {
        await axios.post("http://192.168.100.32:8000/api/saveiteracion/", {
          id_lead: id_lead,
