...
const ModalLead = ({ isOpen, onClose, onLeadAdded }) => {
            ...
            const fetchCatalogos = async () => {
                ...
                try {
                    const [resOrigen, resProyectos] = await Promise.all([
                        axios.get('http://192.168.100.32:8000/api/getorigen/'),
                        axios.get('http://192.168.100.32:8000/api/getpoyectos/')
                    ]);
    ...
    try {
        const response = await axios.post('http://192.168.100.32:8000/api/savelead/', payload);
